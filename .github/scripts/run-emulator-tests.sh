...
PACKAGE_NAME="com.sbokatuk.mcsdknet.devicetests"
...
PROJECT="${REPO_ROOT}/tests/MarketingCloudSDK.Net.Android.DeviceTests/MarketingCloudSDK.Net.Android.DeviceTests.csproj"
