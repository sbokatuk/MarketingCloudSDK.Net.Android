...
public class PackageLayoutTests
{
    ...
    public void Every_expected_package_was_built_and_nothing_else()
    {
        ...
        // nuget.org - so they are tolerated; anything else is a stale leftover.
        var allowed = Packages.All
        ...
        Assert.Equal(expected, found.Where(id => !allowed.Contains(id)).ToList());
